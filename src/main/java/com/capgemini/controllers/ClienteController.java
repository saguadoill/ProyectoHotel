...
public class ClienteController {
	...
	public ResponseEntity<ClienteDTO> findCliente(@RequestParam String email, @RequestParam String password){
		
		return new ResponseEntity<>(clienteService.findCliente(email, password),HttpStatus.OK);
	}
